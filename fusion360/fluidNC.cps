/**
  ...
  FluidNC post processor configuration, adapted from Grbl.
...
description = "FluidNC";
vendor = "fluidnc";
vendorUrl = "http://wiki.fluidnc.com/";
longDescription = "Custom post for FluidNC/BuildBrighton_CNC.";
...
var coolants = [
  {id:COOLANT_FLOOD},
  {id:COOLANT_MIST, on:8, off:8.1},
  {id:COOLANT_THROUGH_TOOL},
  {id:COOLANT_AIR, on:7, off:7.1},
